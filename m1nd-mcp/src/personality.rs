...
pub fn tool_docs() -> Vec<ToolDoc> {
    vec![
        ...
        ToolDoc {
            ...
            returns: "Verdict, checks, binding fingerprint, graph state, session handshake, and optional recovery playbook",
            example: r#"{"agent_id": "jimi"}"#,
        ...
        ToolDoc {
            ...
            returns: "Status, trust mode, binding fingerprint, graph/tool summaries, and ordered recovery steps",
