...
| `federate_auto` | Turn external paths, manifest/workspace hints, import/package names, or shared API-route evidence into repo candidates and an optional one-shot federation plan |
