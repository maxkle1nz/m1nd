...
| `federate_auto` | Turn external paths, manifest/workspace hints, or import/package-name evidence into repo candidates and an optional one-shot federation plan |
