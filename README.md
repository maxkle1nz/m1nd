...
| `federate_auto` | Turn external paths, manifest/workspace hints, import/package names, shared API-route evidence, or contract artifacts like `.proto`, MCP tools, and OpenAPI schema/components into repo candidates and an optional one-shot federation plan |
