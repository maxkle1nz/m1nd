...
| `federate_auto` | Turn external paths, manifest/workspace hints, import/package names, shared API-route evidence, or basic contract artifacts into repo candidates and an optional one-shot federation plan |
