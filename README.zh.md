...
<h3 align="center">面向 MCP 代理的本地代码图引擎。</h3>

<p align="center">
  m1nd 会把一个仓库转成一个可查询的图，这样代理就能直接询问结构、影响范围、关联上下文和潜在风险，而不是每次都从原始文件重新拼出整个形状。
</p>

<p align="center">
  <em>本地执行。Rust 工作区。通过 stdio 提供 MCP，同时在当前默认构建中包含 HTTP/UI 界面。</em>
</p>
...
<p align="center">
  <a href="#why-use-m1nd">为什么使用 m1nd</a> &middot;
  <a href="#quick-start">快速开始</a> &middot;
  <a href="#when-it-is-useful">何时有用</a> &middot;
  <a href="#when-plain-tools-are-better">何时纯工具更合适</a> &middot;
  <a href="#choose-the-right-tool">选择合适的工具</a> &middot;
  <a href="#configure-your-agent">配置你的代理</a> &middot;
  <a href="#results-and-measurements">结果</a> &middot;
  <a href="#tool-surface">工具</a> &middot;
