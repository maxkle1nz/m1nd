...
| v0.6.0 — Guided Runtime & Recovery | proof_state, next-step guidance, trail continuity, apply_batch progress, benchmarked recovery | 5 |
...
m1nd v0.6.0 is the current release line. Add it from [crates.io](https://crates.io/crates/m1nd-core) or build the binary from source — both paths are fully supported.
