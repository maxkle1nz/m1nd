...
- **F11-a (backend):** `candidate_edit` + all six ops + atomic batch + the anti-lie tests (ratified-refuses; OCC conflict intact; seam-rewrites-both-sides; merge-unions-and-rewrites-sockets; dangling-socket-aborts; provenance stamps).
