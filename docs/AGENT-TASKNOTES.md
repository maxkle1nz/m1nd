...
### 2026-04-05 — `federate_auto` now covers explicit paths, manifests, imports, route-level API matches, contract artifacts, and simple schema/component names, but deeper service discovery is still missing
