# Bug Hunt Round Notes: bughunt-p-limit-mc0-sweep-20260517T211556Z

Status: internal product learning, not public benchmark copy.

## Result

- `direct`: 9/10 seeded bugs found (90.0%); per-lane counts `[5, 4]`.
- `m1nd-mission-control`: 10/10 seeded bugs found (100.0%); per-lane counts `[5, 5]`.
  Mission Control: loop-complete lanes `2/2`, unavailable lanes `0`, median `mission_next` count `5.5`, median direct-proof switches `2.0`, median coverage sweeps `1.0`, median adherence `1.0`.
