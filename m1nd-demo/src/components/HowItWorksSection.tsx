...
const STEPS = [
  ...
  },
  {
    ...
    glyphColor: "#00f5ff",
    title: "Orient",
    body: "The agent asks by structure and intent. m1nd returns what is connected, risky, and relevant before the model reconstructs context from scratch by scanning files.",
    stat: "543ns",
  ...
  },
  {
    ...
    stat: "act · reverify · abstain",
    statSub: "calibrated verdicts, not guesses",
    statColor: "#7b61ff",
    connector: false,
  },
];
