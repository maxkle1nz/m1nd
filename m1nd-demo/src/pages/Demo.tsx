...
const BEAT_DEFS = [
  ...
  },
  {
    ...
    desc: "The top candidate nodes are scored against the query with keyword, trigram and centrality signals (plus a small local embedding model when the embed feature is compiled in). The 4 highest-ranked nodes light up as seeds: the starting points for spreading activation. Everything else stays dark.",
    tech: "lexical + trigram + centrality scoring · optional local embeddings · 4 seeds chosen",
    color: "#ffb700",
  },
  {
    animStart: 7,
