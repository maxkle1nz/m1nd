...
export default function Landing() {
  return (
    <main className="w-full min-h-screen bg-background">
      <SEO
        title="m1nd — Operational Intelligence for Coding Agents"
        description="m1nd gives coding agents durable operational context for code, docs, and change before they search, edit, review, or act. Local-first, MCP-native, and built in Rust."
        canonicalPath="/"
      />
      <NavBar />
      <Hero />
